...
-- Answer 1
SELECT RESCUEDATE, DAY(RESCUEDATE) AS Day FROM PETRESCUE;

-- Answer 2
SELECT SUM(QUANTITY) AS MAY_RESCUES FROM PETRESCUE WHERE MONTH(RESCUEDATE) = '5';

-- Answer 3
SELECT SUM(QUANTITY) AS Day14_RESCUES FROM PETRESCUE WHERE DAY(RESCUEDATE) = '14';

-- Answer 4
SELECT RESCUEDATE, (RESCUEDATE + 3 DAYS) AS VET_DAY FROM PETRESCUE;

-- Answer 5
SELECT RESCUEDATE, (CURRENT_DATE - RESCUEDATE) AS TIME_HERE FROM PETRESCUE;
